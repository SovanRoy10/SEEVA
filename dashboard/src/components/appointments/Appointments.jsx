        ...
        <table className="text-sm text-left text-black">
          ...
          <tbody>
            <tr className="bg-white border-b">
              ...
              <td className="py-4 px-6">Rupal</td>
              <td className="py-4 px-6">Pal</td>
              <td className="py-4 px-6">roysovan204@gmail.com</td>
              <td className="py-4 px-6">8439306329</td>
              <td className="py-4 px-6">09/12/2002</td>
              <td className="py-4 px-6">Male</td>
              <td className="py-4 px-6">04/24/2024</td>
              <td className="py-4 px-6">Gynecologist</td>
              <td className="py-4 px-6">SOUMYA SUVRA PATRA</td>
              <td className="py-4 px-6">dumdum road</td>
              <td className="py-4 px-6">
                <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                  Yes
                </span>
              </td>
              <td className="py-4 px-6">Approved</td>
